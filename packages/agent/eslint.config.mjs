...
/**
 * Minimal config, mirroring packages/email-sdk — typecheck covers correctness;
 * this enforces ONLY the owner's code style: any function with more than 2
 * parameters must take a single object argument instead.
 */
export default [
  {
    files: ["**/*.ts", "**/*.tsx"],
