...
- Give each composed draft a \`subject\` and \`previewText\` that are faithful to that draft's own copy. Keep them concise inbox metadata, not a second pitch with new claims. If the rendered email's first heading and paragraph already work, you may omit either field and the draft will derive it from those words. Never invent recipients or an audience address — recipient defaults remain the user's to choose.
