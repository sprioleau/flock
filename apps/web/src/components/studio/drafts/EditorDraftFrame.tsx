  ...
  return (
    ...
    >
      ...
      {/* Floating per-frame toolbar (viewport toggle + HTML export), active
          frame only: STICKY against the frames surface (the one scroller) so
          it stays reachable while scrolling a tall email; zero-height wrapper
          so it never shifts the canvas below. */}
      {isActive && (
